...
public final class S2TestDataHolder extends TestDataHolder {
    ...
    private List<S2HeadersTestData> generateNullOrEmptyHeadersTestData() {
        ...
        testData.add(new S2HeadersTestData(
                ...
                new HashMap<>() {{
                    put(S2Header.HEADER1.getHeaderName(), null);
                    put(S2Header.HEADER2.getHeaderName(), null);
                    put(S2Header.HEADER3.getHeaderName(), null);
                    put(S2Header.HEADER4.getHeaderName(), null);
                    put(S2Header.HEADER5.getHeaderName(), null);
                }},
                true
        ));
        ...
        testData.add(new S2HeadersTestData(
                ...
                new HashMap<>() {{
                    put(S2Header.HEADER1.getHeaderName(), "");
                    put(S2Header.HEADER2.getHeaderName(), "");
                    put(S2Header.HEADER3.getHeaderName(), "");
                    put(S2Header.HEADER4.getHeaderName(), "");
                    put(S2Header.HEADER5.getHeaderName(), "");
                }},
                false
        ));

        for(S2Header header: S2Header.values()){
            if(header == S2Header.HEADER2){
