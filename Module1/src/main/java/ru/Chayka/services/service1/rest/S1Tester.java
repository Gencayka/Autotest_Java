...
import ru.Chayka.services.service1.rest.enums.S1Header;
...
import ru.Chayka.services.service1.rest.requestbody.*;
import ru.Chayka.services.service1.rest.responsebody.*;
...
public final class S1Tester extends RestRequestTester <S1TestDataHolder> {
    ...
    public S1Tester(@Autowired S1TestDataHolder testDataHolder,
        ...
        defaultHeaders.put(S1Header.HEADER1.getHeaderName(), testDataHolder.getDefaultHeader1());
        defaultHeaders.put(S1Header.HEADER2.getHeaderName(), testDataHolder.getDefaultHeader2());
        defaultHeaders.put(S1Header.HEADER3.getHeaderName(), testDataHolder.getDefaultHeader3());
        defaultHeaders.put(S1Header.HEADER4.getHeaderName(), testDataHolder.getDefaultHeader4());
    ...
    public void specificHeadersTest(String testName,
        ...
        localRequestHeaders.put(S1Header.HEADER5.getHeaderName(), testDataHolder.formHeader5());
        localRequestHeaders.put(S1Header.HEADER6.getHeaderName(), testDataHolder.formHeader6(testName));
    ...
    private void checkResponseHeaders(Map<String, String> requestHeaders,
        ...
        requiredHeadersSet.remove(S1Header.HEADER2.getHeaderName());
        requiredHeadersSet.add(S1Header.HEADER7.getHeaderName());

        Map<String, String> headersPatterns = new HashMap<>();
        for (S1Header headerPattern : S1Header.values()) {
